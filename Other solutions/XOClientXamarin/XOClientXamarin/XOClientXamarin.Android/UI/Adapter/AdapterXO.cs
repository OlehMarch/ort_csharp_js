...
namespace XOClientXamarin.Droid.UI.Adapter
{
    public class AdapterXO : BaseAdapter
    {
        ...
        private void InvitationBox(string playerName)
        {
            ...
            aDialogBuilder.SetTitle(context.Resources.GetString(Resource.String.messagebox_invitation_header));
            aDialogBuilder.SetMessage(context.Resources.GetString(Resource.String.messagebox_invitation_message) + " " + playerName + "?");
